...
function DefaultMarkerIcon() {
  return (
    <div className="relative">
      {/* glow */}
      <span className="absolute inset-0 rounded-full bg-yellow-400/40 blur-md" />

      {/* pulse */}
      <span className="absolute inset-0 rounded-full bg-yellow-400/30 animate-ping" />

      {/* main dot */}
      <div className="relative size-4 rounded-full bg-yellow-400 border-2 border-white shadow-xl" />
    </div>
  );
}
  ...
  return (
    <div
      className="
        ...
        [&>button:not(:last-child)]:border-white/10
      "
    >
      {children}
    </div>
